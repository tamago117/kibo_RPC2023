...
//X : right,left Y : back, front Z : down,up
    ...
    // point1 -> ( point5, point6, point7, wp2, wp3)
    ...
    Waypoint point5 = new Waypoint(10.992, -8.084, 5.34,
            0, -0.707, 0, 0.707,
            0, 0, 0);    // Point
    // point6 -> (point1, point7, wp1, wp2)
    Waypoint point6 = new Waypoint(11.21, -9.045, 4.941,
            0, 0, 0, 1,
            0, 0, 0);    // Point
    // point7 -> (point1, point6, wp2)
    ...
    // wp1 -> (point2, point6, point7, wp1, wp3, start)
    Waypoint wp1 = new Waypoint(10.508, -9.769, 4.567,
            0, 0, 0, 1,
            0, 0, 0);    // way point
    // wp2 -> (point1, point2, point3, point4, point5, point6, point7, wp1, wp3)
